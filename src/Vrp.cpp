...
int Vrp::solve(string dataFile)
{
   ...
   if ( read_problem(dataFile.c_str(), num_nodes, capacity, demand, distance) )
   {
      cerr << "Error reading data file " << dataFile << endl;
      return 1;
   }
