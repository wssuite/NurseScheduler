...
// but there is also a global limit on the number of threads used.
  ...
  class ThreadsPool {
    public:
      ...
      // if maximum number of threads decreases, wait for some to be released if wait is true.
    ...
    private:
      static int maxGlobalThreads_; // global maximum number of threads
      static int nGlobalThreadsAvailable_; // global number of available threads  for the local pool
      static bool settingMaxGlobalThreads_; // true if currently trying to set the maxGlobalThreads_
    ...
    private:
      ...
      int nThreadsAvailable_; // local number of available threads for the local pool
