...
protected:
	...
	//
	Solver * setSolverWithInputAlgorithm(Demand* pDemand, SolverParam& param);
	Solver* setSolverWithInputAlgorithm(Demand* pDemand, Algorithm algorithm, SolverParam& param);
