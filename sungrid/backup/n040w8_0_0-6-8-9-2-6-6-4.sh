...
./bin/optimalRoster n040w8 0 0 6 8 9 2 6 6 4 n040w8_0_0-6-8-9-2-6-6-4 $1 > outfiles/Competition/n040w8_0_0-6-8-9-2-6-6-4/${1}Log.txt

instance=n040w8
weeksValue=(0 6 8 9 2 6 6 4 )

demand0="WD-${instance}-"
solutionFile="outfiles/Competition/n040w8_0_0-6-8-9-2-6-6-4/${1}Sol-n040w8-06892664-"
weeks=""
sols=""
i=0
