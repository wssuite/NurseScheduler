...
./bin/optimalRoster n080w4 2 6 0 4 8 n080w4_2_6-0-4-8 $1 > outfiles/Competition/n080w4_2_6-0-4-8/${1}Log.txt

instance=n080w4
weeksValue=(6 0 4 8 )

demand0="WD-${instance}-"
solutionFile="outfiles/Competition/n080w4_2_6-0-4-8/${1}Sol-n080w4-6048-"
weeks=""
sols=""
i=0
