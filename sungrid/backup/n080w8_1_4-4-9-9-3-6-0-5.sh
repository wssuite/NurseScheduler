...
./bin/optimalRoster n080w8 1 4 4 9 9 3 6 0 5 n080w8_1_4-4-9-9-3-6-0-5 $1 > outfiles/Competition/n080w8_1_4-4-9-9-3-6-0-5/${1}Log.txt

instance=n080w8
weeksValue=(4 4 9 9 3 6 0 5 )

demand0="WD-${instance}-"
solutionFile="outfiles/Competition/n080w8_1_4-4-9-9-3-6-0-5/${1}Sol-n080w8-44993605-"
weeks=""
sols=""
i=0
