...
./bin/optimalRoster n100w4 0 1 1 0 8 n100w4_0_1-1-0-8 $1 > outfiles/Competition/n100w4_0_1-1-0-8/${1}Log.txt

instance=n100w4
weeksValue=(1 1 0 8 )

demand0="WD-${instance}-"
solutionFile="outfiles/Competition/n100w4_0_1-1-0-8/${1}Sol-n100w4-1108-"
weeks=""
sols=""
i=0
