...
./bin/optimalRoster n100w8 1 2 4 7 9 3 9 2 8 n100w8_1_2-4-7-9-3-9-2-8 $1 > outfiles/Competition/n100w8_1_2-4-7-9-3-9-2-8/${1}Log.txt

instance=n100w8
weeksValue=(2 4 7 9 3 9 2 8 )

demand0="WD-${instance}-"
solutionFile="outfiles/Competition/n100w8_1_2-4-7-9-3-9-2-8/${1}Sol-n100w8-24793928-"
weeks=""
sols=""
i=0
