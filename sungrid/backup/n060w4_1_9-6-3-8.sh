...
./bin/optimalRoster n060w4 1 9 6 3 8 n060w4_1_9-6-3-8 $1 > outfiles/Competition/n060w4_1_9-6-3-8/${1}Log.txt

instance=n060w4
weeksValue=(9 6 3 8 )

demand0="WD-${instance}-"
solutionFile="outfiles/Competition/n060w4_1_9-6-3-8/${1}Sol-n060w4-9638-"
weeks=""
sols=""
i=0
