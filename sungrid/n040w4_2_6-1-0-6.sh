...
./bin/optimalRoster n040w4 2 6 1 0 6 n040w4_2_6-1-0-6 $1 > outfiles/Competition/n040w4_2_6-1-0-6/${1}Log.txt

instance=n040w4
weeksValue=(6 1 0 6 )

demand0="WD-${instance}-"
solutionFile="outfiles/Competition/n040w4_2_6-1-0-6/${1}Sol-n040w4-6106-"
weeks=""
sols=""
i=0
