...
./bin/optimalRoster n080w4 2 4 4 3 3 3 n080w4_2_4-3-3-3 $prefix $2 $3 $4 $5 > outfiles/Competition/n080w4_2_4-3-3-3/${1}Log.txt

instance=n080w4
weeksValue=(4 3 3 3 )

demand0="WD-${instance}-"
solutionFile="outfiles/Competition/n080w4_2_4-3-3-3/${1}sol-week"
weeks=""
sols=""
i=0
