...
./bin/optimalRoster n050w4 0 4 0 4 8 7 n050w4_0_0-4-8-7 $prefix $2 $3 $4 $5 > outfiles/Competition/n050w4_0_0-4-8-7/${1}Log.txt

instance=n050w4
weeksValue=(0 4 8 7 )

demand0="WD-${instance}-"
solutionFile="outfiles/Competition/n050w4_0_0-4-8-7/${1}sol-week"
weeks=""
sols=""
i=0
