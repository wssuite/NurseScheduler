...
./bin/optimalRoster n030w4 1 4 6 7 5 3 n030w4_1_6-7-5-3 $prefix $2 $3 $4 $5 > outfiles/Competition/n030w4_1_6-7-5-3/${1}Log.txt

instance=n030w4
weeksValue=(6 7 5 3 )

demand0="WD-${instance}-"
solutionFile="outfiles/Competition/n030w4_1_6-7-5-3/${1}sol-week"
weeks=""
sols=""
i=0
