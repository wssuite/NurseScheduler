...
java -jar validator.jar --sce datasets/n050w4/Sc-n050w4.txt --his datasets/n050w4/H0-n050w4-0.txt --weeks $weeks --sols $sols > outfiles/Competition/n050w4_0_7-2-7-2/${1}ValidatorOutput.txt 
