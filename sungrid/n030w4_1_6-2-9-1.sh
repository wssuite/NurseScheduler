...
./bin/optimalRoster n030w4 1 6 2 9 1 n030w4_1_6-2-9-1 $1 > outfiles/Competition/n030w4_1_6-2-9-1/${1}Log.txt

instance=n030w4
weeksValue=(6 2 9 1 )

demand0="WD-${instance}-"
solutionFile="outfiles/Competition/n030w4_1_6-2-9-1/${1}Sol-n030w4-6291-"
weeks=""
sols=""
i=0
