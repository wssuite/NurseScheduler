...
./bin/optimalRoster n100w4 2 0 6 4 6 n100w4_2_0-6-4-6 $1 > outfiles/Competition/n100w4_2_0-6-4-6/${1}Log.txt

instance=n100w4
weeksValue=(0 6 4 6 )

demand0="WD-${instance}-"
solutionFile="outfiles/Competition/n100w4_2_0-6-4-6/${1}Sol-n100w4-0646-"
weeks=""
sols=""
i=0
