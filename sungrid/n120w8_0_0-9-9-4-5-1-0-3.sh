...
./bin/optimalRoster n120w8 0 0 9 9 4 5 1 0 3 n120w8_0_0-9-9-4-5-1-0-3 $1 > outfiles/Competition/n120w8_0_0-9-9-4-5-1-0-3/${1}Log.txt

instance=n120w8
weeksValue=(0 9 9 4 5 1 0 3 )

demand0="WD-${instance}-"
solutionFile="outfiles/Competition/n120w8_0_0-9-9-4-5-1-0-3/${1}Sol-n120w8-09945103-"
weeks=""
sols=""
i=0
